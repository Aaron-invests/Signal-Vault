...
try:
    ...
    os.system("py -m pip install yfinance colorama pytz numpy pandas")
    import yfinance as yf
    from colorama import Fore, Style, init
    init(autoreset=True)
...
RSI_OVERSOLD   = 30
RSI_OVERBOUGHT = 70
TELEGRAM_TOKEN = "8963519283:AAE0RTEQJ4QRgKyLIWTRAUhGRdl6fyQE7Lk"
CHAT_ID        = "-5144692929"

# ── DISCORD WEBHOOK & ROLES ────────────────────────────────────
DISCORD_WEBHOOK_URL  = "https://discord.com/api/webhooks/1518427069162197014/F-ZxH5UAEoDCf53dt1QC2-ZnBDZ8PYcySkQZ1GNNI5NZR1kKT9tIFR_4t49wsyRtpvLe"
